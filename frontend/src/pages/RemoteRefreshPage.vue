  ...
  <section class="remote-refresh-layout">
    <article class="surface section-card remote-refresh-card">
      <div class="section-card__header">
        ...
        <span :class="['count-pill', remoteRefreshState.running || hasActiveRun ? 'count-pill--warn' : 'count-pill--ok']">
          {{ remoteRefreshState.running || hasActiveRun ? "运行中" : `${remoteRefreshState.last_batch_succeeded || 0} 成功 / ${remoteRefreshState.last_batch_failed || 0} 失败` }}
        </span>
      </div>
