...
DEFAULT_CONTAINER_DATA_DIR = Path("/app/data")
LEGACY_CONTAINER_ARCHIVE_DIR = DEFAULT_CONTAINER_DATA_DIR / "archive"
...
def _resolve_archive_dir(env_name: str, fallback: Path) -> Path:
    ...
    if configured == LEGACY_CONTAINER_ARCHIVE_DIR:
...
ARCHIVE_DIR = _resolve_archive_dir("MAKERHUB_ARCHIVE_DIR", RUNTIME_DIR / "data")
...
LOCAL_PREVIEW_MAX_BYTES = _resolve_int("MAKERHUB_LOCAL_PREVIEW_MAX_BYTES", 24 * 1024 * 1024)
LOCAL_PREVIEW_TIMEOUT_SECONDS = _resolve_int("MAKERHUB_LOCAL_PREVIEW_TIMEOUT_SECONDS", 60)
LOCAL_PREVIEW_POLL_SECONDS = _resolve_int("MAKERHUB_LOCAL_PREVIEW_POLL_SECONDS", 20)
